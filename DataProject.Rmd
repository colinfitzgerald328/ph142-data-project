...
```
Looking at the visualization, we can see that there appears to be a difference in the distribution of counts of obesity level by gender, which means a chi-squared test for independence would be appropriate to test that presumption. 
